...
func TestGoFetchNoHost(t *testing.T) {
	launchhttpd(t)
	...
	if resp.Close != true {
		t.Fatalf("Expected to close connection got: %v\n", resp.ContentLength)
	}
}

func TestGoFetchHeaderSpace(t *testing.T) {
...
func TestGoFetchBadRequestTimeout(t *testing.T) {
	launchhttpd(t)

	req := fmt.Sprint("GET /index.html HTTP/1.1\r\n"+
		"Host: website1\r\n",
		"Connection:\r\n",
		"\r\n")
