...
// Usage String
const USAGE_STRING = "./run-server.sh -s <service_type> -p <port> -l -d (blockStoreAddrs*)"
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(w, "  (blockStoreAddrs*): BlockStore Address (include self if service type is both)\n")
	}
